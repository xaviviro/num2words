...
from . import (lang_AM, lang_AR, lang_AZ, lang_BY, lang_CZ, lang_DE, lang_DK,
               ...
               lang_ES_GT, lang_ES_NI, lang_ES_VE, lang_EUS, lang_FA, lang_FI,
               lang_FR, lang_FR_BE, lang_FR_CH, lang_FR_DZ, lang_GL, lang_HE,
               lang_HU, lang_ID, lang_IS, lang_IT, lang_JA, lang_KN, lang_KO,
               lang_KZ, lang_LT, lang_LV, lang_NL, lang_NO, lang_PL, lang_PT,
               lang_PT_BR, lang_RO, lang_RU, lang_SK, lang_SL, lang_SR, lang_SV,
               lang_TE, lang_TG, lang_TH, lang_TR, lang_UK, lang_VI, lang_CA)
